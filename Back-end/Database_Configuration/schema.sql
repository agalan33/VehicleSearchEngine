...
CREATE TABLE reservation(vid int references vehicle(vid), eid int references employee(eid), did int references dealer(did), date varchar(40), primary key (vid, did, eid));